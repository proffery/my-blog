...
import { ModeratePostsTable } from '@/components/pages/moderator-page/moderate-posts-table/moderate-posts-table'
...
export default withSuspense(withRedux(ModeratorPage))
