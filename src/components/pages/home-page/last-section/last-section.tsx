...
import { LastPostCard } from '@/components/pages/home-page/last-section/last-post-card/last-post-card'
import { OtherPostCard } from '@/components/pages/home-page/last-section/other-posts-card/other-posts-card'
