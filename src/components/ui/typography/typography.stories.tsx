...
export const H5: Story = {
  render: () => (
    <Typography.H5>Carosserie Test Zürich Stauffacherstrasse 31 8004 Zürich, ZH, CH</Typography.H5>
  ),
}
export const H6: Story = {
  render: () => (
    <Typography.H6>Carosserie Test Zürich Stauffacherstrasse 31 8004 Zürich, ZH, CH</Typography.H6>
  ),
}
